...
namespace RealmsServer {
  ...
  async function testPlayer() {
    ...
    player.name = "Plagiatus";
    player.email = "therealplagiatus@gmail.com";
    player.password = "Torwart1";
    player.accessToken = "cc0bab9e2fa24ee087be43a86041c8ac"; //"851967f6b1544825a99c5ca0896becf0";
